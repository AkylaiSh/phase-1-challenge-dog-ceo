...
.then((responseObj) => {
  ...
  // responseObj.message.forEach(turnURLToHTML)
})
...
.then((response) => {
  ...
  // Another Way using For In

  // for(let theNameYouWantToGiveToOneOfYourKeys in theObjectYouAreWorkingWith){
  // console.log("Key", theNameYouWantToGiveToOneOfYourKeys);
  // console.log("Value", theObjectYouAreWorkingWith[theNameYouWantToGiveToOneOfYourKeys])
  // }

  // for (let name in response.message) {
  //   console.log("Key", name);
  //   console.log("Value", response.message[name])
  // }
})
